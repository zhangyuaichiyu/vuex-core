<template>
  	<div>
        ...
        <div class="share_code">
            <header class="share_header">关注小雨之家，获取答案。</header>
            <img src="../../images/cord.png" height="212" width="212" class="code_img">
        </div>
...
export default {
  ...
  data(){
    return {
      ...
      scoreTipsArr:['你说,是不是把知识都还给小学老师了？','还不错,但还需要继续加油哦！','不要嘚瑟还有进步的空间！','智商离爆表只差一步了！','你也太聪明啦,小雨之家欢迎你！'],
    }
  },
  ...
  methods: {
    ...
    computedScore(){
        this.answerid.forEach((item, index) => {
            ...
            this.setCookie('score',this.score,this.number);
        })
    },
    //是否显示分享提示
    showCover: function (){
